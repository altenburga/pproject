 ...
 *          Changelog:
 * 
 *          v1.0.1: Added command to request the leaderboard.
 * 
 *          v1.0.0: Initial version of the protocol
 * 
 */
...
public interface Protocol {
	 ...
	 * PAY ATTENTION:
	 * 
	 * All arguments must be separated by a space. This also implies that the
	 * individual arguments are not allowed to contain spaces. The only
	 * exception to this rule will be the chat function.
	 */
	 ...
	 * or not - leaderboard = Whether the client supports leaderboard or not -
	 * security = Whether the client supports security functionalities or not
	 * 
	 * Requirements for arguments: - chat = 0 || 1 - challenge = 0 || 1 -
	 * leaderboard = 0 || 1 - security = 0 || 1
	 * 
	 * Example:
	 * 
	 * My client, niek, wants to join and only support the chat feature Code:
	 * "joinrequest niek 1 0 0 0"
	 * 
	 ...
	 * leaderboard = 0 || 1 - security = 0 || 1
	 * 
	 * Example: Following up on the before mentioned joinrequest, the server
	 * only support the challenge feature and the leaderboard
	 * 
	 ...
	 * 
	 * Requirements for arguments: - name is not allowed to contain spaces
	 * 
	 * Example: If there is already a client named 'niek'
	 * 
	 ...
	 * second player
	 * 
	 * Example: A game is being started for the clients 'niek' and 'victor'
	 * 
	 ...
	 * 
	 * Example: It is my turn to do a move
	 * 
	 ...
	 * board
	 * 
	 * Note: See image in the repo for the directions of the x,y,z axis
	 * 
	 * Extra: - The individual implementation of the game has to calculate the y
	 * coordinate (in the form of a gravityMethod)
	 *
	 * Example: I want to place a move on the position x = 0 && z = 1
	 * 
	 * code: "setmove 0 1"
	 * 
	 * Direction: Client -> Server
	 ...
	 * the board - z = z Coordinate on the board
	 * 
	 * Example: niek placed a move on x = 1 && y = 0 && z = 0
	 * 
	 ...
	 * 
	 * Arguments: - name = Name of the client that won the game
	 * 
	 * Example: victor wins the game
	 * 
	 * code: "gameover victor Direction: Server -> Client
	 */
	 ...
	 * 
	 * Example: I (niek) want to challenge victor to a game
	 * 
	 ...
	 * 
	 * Example: victor challenges me to a game
	 * 
	 ...
	 * 
	 * Requirements for arguments: - answer = 0 || 1
	 * 
	 * Example: I am responding to the challenge that victor send me, and I
	 * accept it
	 * 
	 ...
	 * 
	 * Arguments: - answer = The answer to the challenge - name = Name of the
	 * client that answered the challenge
	 * 
	 * Requirements for arguments: - answer = 0 || 1
	 * 
	 * Example: My previous response that is being broadcasted to the challenger
	 * (victor)
	 * 
	 ...
	 * 
	 * Arguments: - name = Name of the player - score = The score of the game -
	 * time = date and time when the game was played
	 * 
	 * Requirements for arguments: - score = 0 || 1 (also the client that
	 * disconnects, loses the game - time = UNIX Timestamp
	 * 
	 * Example: I won my last game
	 * 
	 ...
	 * time = date and time when the game was played
	 * 
	 * Note: This is done as often as needed. Untill all the entries in the
	 * leaderboard are returned
	 * 
	 * Example: There are 2 entries in the leaderbaord:
	 * 
